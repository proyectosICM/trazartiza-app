    ...
    class BleDeviceActivity : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            val inputVolumen = findViewById<TextInputEditText>(R.id.input_volumen)
            ...
            btnEnviar.setOnClickListener {
                ...
                val volumenText = inputVolumen.text.toString().trim()

                if (volumenText.isEmpty()) {
                    Toast.makeText(this, "Ingresa un valor de volumen", Toast.LENGTH_SHORT).show()
                    return@setOnClickListener
                }

                val umbralParte = if (minText.isNotEmpty() && maxText.isNotEmpty()) {
                    "$minText,$maxText"
                } else {
                    ","
                }

                val message = "$umbralParte|$volumenText"
